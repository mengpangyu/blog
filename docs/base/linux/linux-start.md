...
![进入 /boot](./images/linux-start-1.png)

## 运行 init

init 是所有进程的源头，首先读取的文件是 /etc/inittab

![进入 /init](./images/linux-start-2.png)
...
![进入 运行级别](./images/linux-start-3.png)
...
![进入 系统初始化](./images/linux-start-4.png)
...
![进入 登录系统](./images/linux-start-5.png)
...
![进入 登录](./images/linux-start-6.png)
